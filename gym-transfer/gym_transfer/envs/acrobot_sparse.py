"""
Acrobot-v1 environment with modified reward function. Terminal state has reward 1, everywhere else 0. 
"""
import numpy as np
...
class AcrobotEnvSparse(core.Env):
    ...
    **REFERENCE:**
    ...
    def __init__(self):
        self.viewer = None
        self.terminal_reward  = 1. ## Reward to give in terminal state
...
#         reward = -1. if not terminal else 0.
        reward = 0. if not terminal else self.terminal_reward        
