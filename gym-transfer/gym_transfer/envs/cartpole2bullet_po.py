"A modified version of cartpole env using pybullet with collisions and different observability settings."
...
class CartPoleBulletPOEnv(gym.Env):
    """
    Description:
    ...
    def __init__(self):
        ...
        self.INIT_BOTT = True    # Initializes episode with downright pole   
        self.ALLOW_BOTT = True or self.INIT_BOTT  # Allows swinging from the bottom, always True if INIT_BOTT is True.
        self.TRIG_OBS = True # Observations are as sine and cosines
        self.REW_TOP_TOL = False ## For a reward, get the pole upright
        self.REW_TOP_CONS = True and not(self.REW_TOP_TOL) ## For reward, keep it at the top for self.CONS_ROUNDS
        self.MAKE_MARKOVIAN = True and self.REW_TOP_CONS ## Adds another observation dimension
        ...
        self.TOP_TOL = 15*math.pi/180 ## Tolerance for counting an angle upright.
        self.CONS_ROUNDS = 15 ## For how many consecutive timesteps pole should be upright for a reward
        self.satisfied = 0
